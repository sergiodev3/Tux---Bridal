...
const clientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_STORE_ADDRESS: optionalString,
  NEXT_PUBLIC_STORE_MAPS_URL: optionalUrl,
  NEXT_PUBLIC_FACEBOOK_URL: optionalUrl,
  NEXT_PUBLIC_WHATSAPP_PHONE: optionalString,
...
function readClientEnv(): Record<string, string | undefined> {
  return {
    ...
    NEXT_PUBLIC_STORE_MAPS_URL: process.env.NEXT_PUBLIC_STORE_MAPS_URL,
